...
namespace GQ_SW_Quality_Check_Tool
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stServicePaymentSelection2Req
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stServicePaymentSelection2Res
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public byte ResCode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stContractAuthentication2Req
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public uint Checksum = 0;
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stContractAuthentication2Res
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public byte ResCode;
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stChargeParameterDiscovery2Req
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stChargeParameterDiscovery2Res
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
    ...
    */
    ...
    class stTestIOCtrl2Req
    {
        ...
        public byte ev_pwr;
        public byte ev_io_wakeup;
        public byte pd1_480_ctrl;
        public byte pd1_s3_ctrl;
        public byte pd2_1500_ctrl;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
        public byte[] reserved3 = new byte[5];
        public uint Checksum =0;
        public stTestIOCtrl2Req()
        { }
        public stTestIOCtrl2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestIOCtrl2Res
    {
        ...
        public stTestIOCtrl2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestIOCtrlRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestIOCtrl2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestIOCtrl2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestIOCtrlRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestIOCtrl2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stTestEOL_Start2Req
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public ushort testItem = 0;
        public byte ErrorCode = 0;
        public byte testState = 0;      // 0: not test 1: init 2: testing 3: finished
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved = new byte[2] {0,0};

        public byte eol_current = 0;
        public byte eol_can = 0;
        public byte eol_micom = 0;
        public byte eol_cp = 0;
        public byte eol_plc = 0;
        public byte eol_sleep = 0;
        public byte eol_wakeup = 0;
        public byte eol_lock = 0;
        public byte eol_crg = 0;
        public byte eol_cc2 = 0;
        public byte eol_pd = 0;
        public byte eol_temperature = 0;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
        public byte[] reserved3 = new byte[3];
        public uint Checksum = 0;

        public stTestEOL_Start2Req()
        { }
        public stTestEOL_Start2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Start2Res
    {
        ...
        public stTestEOL_Start2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_StartRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Start2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }

        public stTestEOL_Start2Res(byte[] a_chSign, byte nResCode = 0, 
                byte eol_current = 0, byte eol_can = 0, byte eol_micom = 0, byte eol_cp = 0, byte eol_plc = 0, byte eol_sleep = 0, byte eol_wakeup = 0, 
                byte eol_lock = 0, byte eol_crg = 0, byte eol_cc2 = 0, byte eol_pd = 0, byte eol_temperature = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_StartRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Start2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stTestEOL_CAN2Req
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public ushort testItem;
        public byte ErrorCode;
        public byte testState = 0;      // 0: not test 1: init 2: testing 3: finished
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved = new byte[2];

        public byte can_baud_rate;
        public byte reserved1;
        public ushort test_cycle_time;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved2 = new byte[2];
        public uint test_time;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved3 = new byte[4];
        public uint Checksum = 0;

        public stTestEOL_CAN2Req()
        { }
        public stTestEOL_CAN2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_CAN2Res
    {
        ...
        public stTestEOL_CAN2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CANRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CAN2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_CAN2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CANRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CAN2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_MICOM2Req
    {
        ...
        public ushort testRepeatNum;
        public ushort bootTimeStandard;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        ...
        public stTestEOL_MICOM2Req()
        { }
        public stTestEOL_MICOM2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_MICOM2Res
    {
        ...
        public stTestEOL_MICOM2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_MicomRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_MICOM2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_MICOM2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_MicomRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_MICOM2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_CP2Req
    {
        ...
        public ushort cp_level;         // 0~4095
        public ushort pwm_duty;         // 0.0~100.0 %
        public ushort pwm_frequency;    // 0~65,000Hz
        public byte cp_state;           // 0: unknown 6: State C  9: State B 12: State A
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved1 = new byte[2];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved2 = new byte[4];
        ...
        public stTestEOL_CP2Req()
        { }
        public stTestEOL_CP2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_CP2Res
    {
        ...
        public stTestEOL_CP2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CPRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CP2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_CP2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CPRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CP2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_PLC2Req
    {
        ...
        public byte connection_state;   // 0: not connection  1: connection
        public byte slac_state;         // 0: none 1: sending slac 2: finished
        public byte avg_attenuation;    // 0~100
        ...
        public stTestEOL_PLC2Req()
        { }
        public stTestEOL_PLC2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    class stTestEOL_PLC2Res
    {
        public Msg_Header2 MsgHeader = new Msg_Header2();
        public ushort testItem;
        public byte ResCode;
        public byte testState;      // 0: not test 1: init 2: testing 3: finished
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved = new byte[2];
        ...
        public stTestEOL_PLC2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_PLCRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_PLC2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_PLC2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_PLCRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_PLC2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_Sleep2Req
    {
        ...
        public byte[] reserved1 = new byte[10];
        public uint Checksum = 0;

        public stTestEOL_Sleep2Req()
        { }
        public stTestEOL_Sleep2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Sleep2Res
    {
        ...
        public stTestEOL_Sleep2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_SleepRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Sleep2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_Sleep2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_SleepRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Sleep2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_WakeUp2Req
    {
        ...
        public byte wakeup_state;   // 0: sleep  1: wake-up
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public byte[] reserved1 = new byte[9];
        public uint Checksum = 0;

        public stTestEOL_WakeUp2Req()
        { }
        public stTestEOL_WakeUp2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_WakeUp2Res
    {
        ...
        public byte wakeup_state;   // 0: sleep  1: wake-up
        public byte wakeup_source;   // 0: none  1: power 2: CAN 3:IO 4:CP PWM 5% more 
        public byte can_baud_rate;     // 0: 250k, 1:500k
        public byte can_cycle_time;     // 0~255ms
        public byte can_repeat_num;     // 0~255
        public byte io_on_time;         // 0_255 ms
        public byte pwm_duty;            // 0~100
        public byte pwm_on_time;        // 0.0~25.5 sec

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved1 = new byte[2];
        public uint Checksum = 0;

        public stTestEOL_WakeUp2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_WakeUpRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_WakeUp2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_WakeUp2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_WakeUpRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_WakeUp2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_Lock2Req
    {
        ...
        public byte lock_state;   // 0: unlock  1: lock on 2: lock fail
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] lock_actuator_type_company = new byte[2];   // 
        public byte lock_volt;      // 12 or 24 V;
        public byte lock_wire_num;  // 3 or 4
        public byte reserved1;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
        public byte[] reserved2 = new byte[12];
        public byte adc_check_time;     // 0~255ms
        public byte adc_check_num;      // 0~100 times
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 200)]
        public ushort[] adc_data = new ushort[100];
        public uint Checksum = 0;

        public stTestEOL_Lock2Req()
        { }
        public stTestEOL_Lock2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Lock2Res
    {
        ...
        public stTestEOL_Lock2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_LockRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Lock2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_Lock2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_LockRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Lock2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_CRG2Req
    {
        ...
        public byte crg_state;   // 0: crg off  1: crg on
        public byte crg_check_state;   // 0: not check  1: checking 2: complete
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved1 = new byte[2];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved2 = new byte[4];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public byte[] reserved3 = new byte[10];
        public byte adc_check_time;
        public byte adc_check_num;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 200)]
        public ushort[] adc_data = new ushort[100];   // ascii code
        public uint Checksum = 0;

        public stTestEOL_CRG2Req()
        { }
        public stTestEOL_CRG2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_CRG2Res
    {
        ...
        public stTestEOL_CRG2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CRGRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CRG2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_CRG2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CRGRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CRG2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_CC22Req
    {
        ...
        public byte cc2_state;      // 0: cc2 off  1: cc2 on
        public byte cc2_resister;   // 0: 0 ohm  1: 1k
        public ushort cc2_adc_data0;
        public ushort cc2_adc_data1;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved1 = new byte[4];
        public uint Checksum = 0;

        public stTestEOL_CC22Req()
        { }
        public stTestEOL_CC22Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_CC22Res
    {
        ...
        public stTestEOL_CC22Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CC2Res;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CC22Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_CC22Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CC2Res;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_CC22Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_PD2Req
    {
        ...
        public byte pd_type;      // 0: none 1: pd type 1 2: pd type 2
        public byte reserved1;
        public ushort pd_adc_data0;
        public ushort pd_adc_data1;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved2 = new byte[4];
        public uint Checksum = 0;

        public stTestEOL_PD2Req()
        { }
        public stTestEOL_PD2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_PD2Res
    {
        ...
        public byte pd_type;      // 0: none 1: pd type 1 2: pd type 2
        public byte pd1_r480;   // 0: 0 ohm  1: 1k
        public byte pd1_s3;
        public byte pd2_r1500;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] reserved1 = new byte[2];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved2 = new byte[4];
        ...
        public stTestEOL_PD2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_PDRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_PD2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_PD2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_PDRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_PD2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_Temp2Req
    {
        ...
        public ushort temp_adc_data0;
        public ushort temp_adc_data1;
        public ushort temp_adc_data2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved1 = new byte[4];
        public uint Checksum = 0;

        public stTestEOL_Temp2Req()
        { }
        public stTestEOL_Temp2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Temp2Res
    {
        ...
        public stTestEOL_Temp2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_TempRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Temp2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_Temp2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_TempRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Temp2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_Current2Req
    {
        ...
        public ushort curr_adc_data0;
        public ushort curr_adc_data1;
        public ushort curr_adc_data2;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] reserved1 = new byte[4];
        public uint Checksum = 0;

        public stTestEOL_Current2Req()
        { }
        public stTestEOL_Current2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Current2Res
    {
        ...
        public stTestEOL_Current2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CurrentRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Current2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_Current2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_CurrentRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Current2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    class stTestEOL_Stop2Req
    {
        ...
        public stTestEOL_Stop2Req()
        { }
        public stTestEOL_Stop2Req(byte[] a_chSign)
        {
            MsgHeader = new Msg_Header2(a_chSign);
        }
    };
    ...
    class stTestEOL_Stop2Res
    {
        ...
        public stTestEOL_Stop2Res(byte nResCode = 0)
        {
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_StopRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Stop2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
            ResCode = nResCode;
        }
        public stTestEOL_Stop2Res(byte[] a_chSign, byte nResCode = 0)
        {
            MsgHeader = new Msg_Header2(a_chSign);
            MsgHeader.Msg_ID = (byte)MsgID.TestEOL_StopRes;
            MsgHeader.Msg_LEN = (byte)(Marshal.SizeOf(typeof(stTestEOL_Stop2Res)) - Marshal.SizeOf(typeof(Msg_Header2)) - Marshal.SizeOf(typeof(uint)));
    ...
    partial class  dcComboPLC
    {
        ...
        public uint req_cnt_start = 0;
        public uint req_cnt_current = 0;
        public uint req_cnt_can = 0;
        public uint req_cnt_micom = 0;
        public uint req_cnt_cp = 0;
        public uint req_cnt_plc = 0;
        public uint req_cnt_sleep = 0;
        public uint req_cnt_wakeup = 0;
        public uint req_cnt_lock = 0;
        public uint req_cnt_crg = 0;
        public uint req_cnt_cc2 = 0;
        public uint req_cnt_pd = 0;
        public uint req_cnt_temperature = 0;
        public uint req_cnt_stop = 0;
...
//      for EOL Test
                ...
                case MsgID.TestEOL_StartReq:
                    {
                        DebugString("receive TestEOL_StartReq" + "\n");

                        curChagerStep = msgid;
                        req_cnt_start++;

                        stTestEOL_Start2Req pTestEOL_Start2Req = new stTestEOL_Start2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Start2Req = (stTestEOL_Start2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Start2Req));
                        }

                        //str_temp = ("eol_can = " + pTestEOL_Start2Req.eol_can);
                        //Console.WriteLine(str_temp);
                        //status_text += (str_temp + "\n");

                        stTestEOL_Start2Res pTestEOL_Start2Res = new stTestEOL_Start2Res(chSign);

                        pTestEOL_Start2Res.eol_current = eol_current;
                        pTestEOL_Start2Res.eol_can = eol_can;
                        pTestEOL_Start2Res.eol_micom = eol_micom;
                        pTestEOL_Start2Res.eol_cp = eol_cp;
                        pTestEOL_Start2Res.eol_plc = eol_plc;
                        pTestEOL_Start2Res.eol_sleep = eol_sleep;
                        pTestEOL_Start2Res.eol_wakeup = eol_wakeup;
                        pTestEOL_Start2Res.eol_lock = eol_lock;
                        pTestEOL_Start2Res.eol_crg = eol_crg;
                        pTestEOL_Start2Res.eol_cc2 = eol_cc2;
                        pTestEOL_Start2Res.eol_pd = eol_pd;
                        pTestEOL_Start2Res.eol_temperature = eol_temperature;

                        if (pTestEOL_Start2Req.testState == (byte)testState.TEST_FINISHED) 
                            pTestEOL_Start2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Start2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Start2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Start2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Start2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_Start2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        str_err = "[res] ResCode =" + pTestEOL_Start2Res.ResCode + "\n";
                        DebugString(str_err);
                        string str_values = "[res]eol_current = 0x" + pTestEOL_Start2Res.eol_current.ToString("x02") + "\n"
                                            + "[res]eol_can = 0x" + pTestEOL_Start2Res.eol_can.ToString("x02") + "\n"
                                            + "[res]eol_micom = 0x" + pTestEOL_Start2Res.eol_micom.ToString("x02") + "\n"
                                            + "[res]eol_cp = 0x" + pTestEOL_Start2Res.eol_cp.ToString("x02") + "\n"
                                            + "[res]eol_plc = 0x" + pTestEOL_Start2Res.eol_plc.ToString("x02") + "\n"
                                            + "[res]eol_sleep = 0x" + pTestEOL_Start2Res.eol_sleep.ToString("x02") + "\n"
                                            + "[res]eol_wakeup = 0x" + pTestEOL_Start2Res.eol_wakeup.ToString("x02") + "\n"
                                            + "[res]eol_lock = 0x" + pTestEOL_Start2Res.eol_lock.ToString("x02") + "\n"
                                            + "[res]eol_crg = 0x" + pTestEOL_Start2Res.eol_crg.ToString("x02") + "\n"
                                            + "[res]eol_cc2 = 0x" + pTestEOL_Start2Res.eol_cc2.ToString("x02") + "\n"
                                            + "[res]eol_pd = 0x" + pTestEOL_Start2Res.eol_pd.ToString("x02") + "\n"
                                            + "[res]eol_temp = 0x" + pTestEOL_Start2Res.eol_temperature.ToString("x02") + "\n";
                        DebugString(str_values);

                        break;
                    }


                case MsgID.TestEOL_CurrentReq:
                    {
                        DebugString("receive TestEOL_CurrentReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_current++;

                        stTestEOL_Current2Req pTestEOL_Current2Req = new stTestEOL_Current2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Current2Req = (stTestEOL_Current2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Current2Req));
                        }



                        stTestEOL_Current2Res pTestEOL_Current2Res = new stTestEOL_Current2Res(chSign);


                        if (pTestEOL_Current2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_Current2Res.testState = (byte)testState.TEST_INIT;


                        if(pTestEOL_Current2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_Current2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Current2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Current2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Current2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Current2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_Current2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_Current2Req.testState + "\n"
                                            + "[req]current[0] = 0x" + pTestEOL_Current2Req.curr_adc_data0.ToString("x04") + "\n"
                                            + "[req]current[1] = 0x" + pTestEOL_Current2Req.curr_adc_data1.ToString("x04") + "\n"
                                            + "[req]current[2] = 0x" + pTestEOL_Current2Req.curr_adc_data2.ToString("x04") + "\n";
                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_Current2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_CANReq:
                    {
                        DebugString("receive TestEOL_CANReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_can++;

                        stTestEOL_CAN2Req pTestEOL_CAN2Req = new stTestEOL_CAN2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_CAN2Req = (stTestEOL_CAN2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_CAN2Req));
                        }

                        stTestEOL_CAN2Res pTestEOL_CAN2Res = new stTestEOL_CAN2Res(chSign);
                        if (pTestEOL_CAN2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_CAN2Res.testState = (byte)testState.TEST_INIT;


                        if (pTestEOL_CAN2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_CAN2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_CAN2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CAN2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_CAN2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CAN2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_CAN2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_CAN2Req.testState + "\n"
                                            + "[req]can_baud_rate = " + pTestEOL_CAN2Req.can_baud_rate + ":" + (pTestEOL_CAN2Req.can_baud_rate==0?"250k":"500k") + " bps\n"
                                            + "[req]test_cycle_time = " + pTestEOL_CAN2Req.test_cycle_time + "ms\n"
                                            + "[req]test_time = 0x" + pTestEOL_CAN2Req.test_time.ToString("x04") + "\n";
                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_CAN2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_MicomReq:
                    {
                        DebugString("receive TestEOL_MicomReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_micom++;

                        stTestEOL_MICOM2Req pTestEOL_MICOM2Req = new stTestEOL_MICOM2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_MICOM2Req = (stTestEOL_MICOM2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_MICOM2Req));
                        }


                        stTestEOL_MICOM2Res pTestEOL_MICOM2Res = new stTestEOL_MICOM2Res(chSign);

                        if (pTestEOL_MICOM2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_MICOM2Res.testState = (byte)testState.TEST_INIT;


                        if (pTestEOL_MICOM2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_MICOM2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_MICOM2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_MICOM2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_MICOM2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_MICOM2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_MICOM2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_MICOM2Req.testState + "\n"
                                            + "[req]boottimestandard = " + pTestEOL_MICOM2Req.bootTimeStandard + " Sec\n"
                                            + "[req]testRepeatNum = " + pTestEOL_MICOM2Req.testRepeatNum + "\n";
                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_MICOM2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_CPReq:
                    {
                        DebugString("receive TestEOL_CPReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_cp++;

                        stTestEOL_CP2Req pTestEOL_CP2Req = new stTestEOL_CP2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_CP2Req = (stTestEOL_CP2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_CP2Req));
                        }

                        stTestEOL_CP2Res pTestEOL_CP2Res = new stTestEOL_CP2Res(chSign);

                        if (pTestEOL_CP2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_CP2Res.testState = (byte)testState.TEST_INIT;


                        if(pTestEOL_CP2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_CP2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_CP2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CP2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_CP2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CP2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_CP2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_CP2Req.testState + "\n"
                                            + "[req]cp_level = " + pTestEOL_CP2Req.cp_level + "\n"
                                            + "[req]cp_state = " + pTestEOL_CP2Req.cp_state + "\n"
                                            + "[req]pwm_duty = " + pTestEOL_CP2Req.pwm_duty + "\n"
                                            + "[req]pwm_frequency = " + pTestEOL_CP2Req.pwm_frequency + "\n";

                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_CP2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_PLCReq:
                    {
                        DebugString("receive TestEOL_PLCReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_plc++;

                        stTestEOL_PLC2Req pTestEOL_PLC2Req = new stTestEOL_PLC2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_PLC2Req = (stTestEOL_PLC2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_PLC2Req));
                        }


                        stTestEOL_PLC2Res pTestEOL_PLC2Res = new stTestEOL_PLC2Res(chSign);

                        if (pTestEOL_PLC2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_PLC2Res.testState = (byte)testState.TEST_INIT;

                        
                        if (pTestEOL_PLC2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_PLC2Res.testState = (byte)testState.TEST_FINISHED;


                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_PLC2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_PLC2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_PLC2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_PLC2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_PLC2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_PLC2Req.testState + "\n"
                                            + "[req]avg_attenuation = " + pTestEOL_PLC2Req.avg_attenuation + "\n"
                                            + "[req]connection_state = " + pTestEOL_PLC2Req.connection_state + "\n"
                                            + "[req]slac_state = " + pTestEOL_PLC2Req.slac_state + "\n";

                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_PLC2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_SleepReq:
                    {
                        DebugString("receive TestEOL_SleepReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_sleep++;

                        stTestEOL_Sleep2Req pTestEOL_Sleep2Req = new stTestEOL_Sleep2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Sleep2Req = (stTestEOL_Sleep2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Sleep2Req));
                        }


                        stTestEOL_Sleep2Res pTestEOL_Sleep2Res = new stTestEOL_Sleep2Res(chSign);

                        if (pTestEOL_Sleep2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_Sleep2Res.testState = (byte)testState.TEST_INIT;


                        if (pTestEOL_Sleep2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_Sleep2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Sleep2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Sleep2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Sleep2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Sleep2Res, (IntPtr)pData, false);
                        }
                        string str_err = "[req] error =" + pTestEOL_Sleep2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_Sleep2Req.testState + "\n";
                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_Sleep2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_WakeUpReq:
                    {
                        DebugString("receive TestEOL_WakeUpReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_wakeup++;

                        stTestEOL_WakeUp2Req pTestEOL_WakeUp2Req = new stTestEOL_WakeUp2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_WakeUp2Req = (stTestEOL_WakeUp2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_WakeUp2Req));
                        }


                        stTestEOL_WakeUp2Res pTestEOL_WakeUp2Res = new stTestEOL_WakeUp2Res(chSign);

                        if (pTestEOL_WakeUp2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_WakeUp2Res.testState = (byte)testState.TEST_INIT;


                        if (pTestEOL_WakeUp2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_WakeUp2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_WakeUp2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_WakeUp2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_WakeUp2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_WakeUp2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_WakeUp2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_WakeUp2Req.testState + "\n"
                                            + "[req]wakeup_state = " + pTestEOL_WakeUp2Req.wakeup_state + "\n";

                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_WakeUp2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_LockReq:
                    {
                        DebugString("receive TestEOL_LockReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_lock++;

                        stTestEOL_Lock2Req pTestEOL_Lock2Req = new stTestEOL_Lock2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Lock2Req = (stTestEOL_Lock2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Lock2Req));
                        }


                        stTestEOL_Lock2Res pTestEOL_Lock2Res = new stTestEOL_Lock2Res(chSign);
                        if (pTestEOL_Lock2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_Lock2Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_Lock2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_Lock2Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Lock2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Lock2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Lock2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Lock2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_Lock2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_Lock2Req.testState + "\n"
                                            + "[req].lock_state = " + pTestEOL_Lock2Req.lock_state + "\n"
                                            +"[req]lock_actuator_type_company (hex)= " + pTestEOL_Lock2Req.lock_actuator_type_company[0].ToString("x02") +" "+ pTestEOL_Lock2Req.lock_actuator_type_company[1].ToString("x02") + "\n"
                                            + "[req]lock_volt = " + pTestEOL_Lock2Req.lock_volt + "V\n"
                                            + "[req].lock_wire_num = " + pTestEOL_Lock2Req.lock_wire_num + "\n"
                                            +"[req]adc_check_time = " + pTestEOL_Lock2Req.adc_check_time + "\n"
                                            + "[req]adc_check_num = " + pTestEOL_Lock2Req.adc_check_num + "\n";

                        for(int cnt = 0;cnt<100;cnt++)
                        {
                            if (cnt != 0 && cnt % 8 == 0)
                                str_values += "\n";
                            str_values += pTestEOL_Lock2Req.adc_data[cnt].ToString("x04") + " ";
                        }
                        str_values += "\n";

                        DebugString(str_values);
                        str_err = "[res] ResCode =" + pTestEOL_Lock2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_CRGReq:
                    {
                        DebugString("receive TestEOL_CRGReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_crg++;

                        stTestEOL_CRG2Req pTestEOL_CRG2Req = new stTestEOL_CRG2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_CRG2Req = (stTestEOL_CRG2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_CRG2Req));
                        }


                        stTestEOL_CRG2Res pTestEOL_CRG2Res = new stTestEOL_CRG2Res(chSign);

                        if (pTestEOL_CRG2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_CRG2Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_CRG2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_CRG2Res.testState = (byte)testState.TEST_FINISHED;


                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_CRG2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CRG2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_CRG2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CRG2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_CRG2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_CRG2Req.testState + "\n"
                                            + "[req]crg_state = " + pTestEOL_CRG2Req.crg_state + "\n"
                                            + "[req]crg_check_state = " + pTestEOL_CRG2Req.crg_check_state + "\n"
                                            + "[req]adc_check_time = " + pTestEOL_CRG2Req.adc_check_time + "\n"
                                            + "[req]adc_check_num = " + pTestEOL_CRG2Req.adc_check_num + "\n";

                        for (int cnt = 0; cnt < 100; cnt++)
                        {
                            if (cnt != 0 && cnt % 8 == 0)
                                str_values += "\n";
                            str_values += pTestEOL_CRG2Req.adc_data[cnt].ToString("x04") + " ";
                        }
                        str_values += "\n";

                        DebugString(str_values);

                        str_err = "[res] ResCode =" + pTestEOL_CRG2Res.ResCode + "\n";
                        DebugString(str_err);
                        
                        break;
                    }

                case MsgID.TestEOL_CC2Req:
                    {
                        DebugString("receive TestEOL_CC2Req" + "\n");
                        curChagerStep = msgid;
                        req_cnt_cc2++;

                        stTestEOL_CC22Req pTestEOL_CC22Req = new stTestEOL_CC22Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_CC22Req = (stTestEOL_CC22Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_CC22Req));
                        }

                        stTestEOL_CC22Res pTestEOL_CC22Res = new stTestEOL_CC22Res(chSign);

                        if (pTestEOL_CC22Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_CC22Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_CC22Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_CC22Res.testState = (byte)testState.TEST_FINISHED;

                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_CC22Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CC22Res, (IntPtr)pData, false);
                        }
                        pTestEOL_CC22Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_CC22Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_CC22Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_CC22Req.testState + "\n"
                                            + "[req]cc2_state = " + pTestEOL_CC22Req.cc2_state + "\n"
                                            + "[req]cc2_resister = " + pTestEOL_CC22Req.cc2_resister + ":"+(pTestEOL_CC22Req.cc2_resister == 0 ? "0 ohm" : (pTestEOL_CC22Req.cc2_resister == 0)?" ":"1k ohm") + "\n"
                                            + "[req]cc2_adc_data0 = 0x" + pTestEOL_CC22Req.cc2_adc_data0.ToString("x04") + "\n"
                                            + "[req]cc2_adc_data1 = 0x" + pTestEOL_CC22Req.cc2_adc_data1.ToString("x04") + "\n";
                        DebugString(str_values);

                        str_err = "[res] ResCode =" + pTestEOL_CC22Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_PDReq:
                    {
                        DebugString("receive TestEOL_PDReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_pd++;

                        stTestEOL_PD2Req pTestEOL_PD2Req = new stTestEOL_PD2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_PD2Req = (stTestEOL_PD2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_PD2Req));
                        }


                        stTestEOL_PD2Res pTestEOL_PD2Res = new stTestEOL_PD2Res(chSign);

                        if (pTestEOL_PD2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_PD2Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_PD2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_PD2Res.testState = (byte)testState.TEST_FINISHED;


                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_PD2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_PD2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_PD2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_PD2Res, (IntPtr)pData, false);
                        }
                        string str_err = "[req] error =" + pTestEOL_PD2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_PD2Req.testState + "\n"
                            + "[req]crg_state = " + pTestEOL_PD2Req.pd_type+":" + (pTestEOL_PD2Req.pd_type== 0?" ":"pd type" + pTestEOL_PD2Req.pd_type) + "\n"
                                            + "[req]pd_adc_data0 = 0x" + pTestEOL_PD2Req.pd_adc_data0.ToString("x04") + "\n"
                                            + "[req]pd_adc_data1 = 0x" + pTestEOL_PD2Req.pd_adc_data1.ToString("x04") + "\n";
                        DebugString(str_values);

                        str_err = "[res] ResCode =" + pTestEOL_PD2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_TempReq:
                    {
                        DebugString("receive TestEOL_TempReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_temperature++;

                        stTestEOL_Temp2Req pTestEOL_Temp2Req = new stTestEOL_Temp2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Temp2Req = (stTestEOL_Temp2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Temp2Req));
                        }

                        stTestEOL_Temp2Res pTestEOL_Temp2Res = new stTestEOL_Temp2Res(chSign);
                        if (pTestEOL_Temp2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_Temp2Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_Temp2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_Temp2Res.testState = (byte)testState.TEST_FINISHED;
                        
                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Temp2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Temp2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Temp2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Temp2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_Temp2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_Temp2Req.testState + "\n"
                                            + "[req]temp_adc_data0 = 0x" + pTestEOL_Temp2Req.temp_adc_data0.ToString("x04") + "\n"
                                            + "[req]temp_adc_data1 = 0x" + pTestEOL_Temp2Req.temp_adc_data1.ToString("x04") + "\n";
                        DebugString(str_values);

                        str_err = "[res] ResCode =" + pTestEOL_Temp2Res.ResCode + "\n";
                        DebugString(str_err);
                ...
                case MsgID.TestEOL_StopReq:
                    {
                        DebugString("receive TestEOL_StopReq" + "\n");
                        curChagerStep = msgid;
                        req_cnt_stop++;

                        stTestEOL_Stop2Req pTestEOL_Stop2Req = new stTestEOL_Stop2Req(chSign);
                        fixed (byte* pData = aData)
                        {
                            pTestEOL_Stop2Req = (stTestEOL_Stop2Req)Marshal.PtrToStructure((IntPtr)pData, typeof(stTestEOL_Stop2Req));
                        }
                        ...
                        stTestEOL_Stop2Res pTestEOL_Stop2Res = new stTestEOL_Stop2Res(chSign);
                        if (pTestEOL_Stop2Req.testState == (byte)testState.NOT_TEST)
                            pTestEOL_Stop2Res.testState = (byte)testState.TEST_INIT;

                        if (pTestEOL_Stop2Req.testState == (byte)testState.TEST_FINISHED)
                            pTestEOL_Stop2Res.testState = (byte)testState.TEST_FINISHED;


                        DataBuffer = new byte[Marshal.SizeOf(typeof(stTestEOL_Stop2Res))];
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Stop2Res, (IntPtr)pData, false);
                        }
                        pTestEOL_Stop2Res.Checksum = getChecksum(DataBuffer);
                        fixed (byte* pData = DataBuffer)
                        {
                            Marshal.StructureToPtr(pTestEOL_Stop2Res, (IntPtr)pData, false);
                        }

                        string str_err = "[req] error =" + pTestEOL_Stop2Req.ErrorCode + "\n";
                        DebugString(str_err);
                        string str_values = "[req]testState = " + pTestEOL_Stop2Req.testState + "\n";
                        DebugString(str_values);

                        str_err = "[res] ResCode =" + pTestEOL_Stop2Res.ResCode + "\n";
                        DebugString(str_err);
