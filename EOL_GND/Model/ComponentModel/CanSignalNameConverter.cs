...
{
    public class CanSignalNameConverter : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                var signal = DbcManager.SharedInstance.FindSignalByName(enteredName, null, out _);
                return signal?.Name;
            }
        ...
        {
            var signalName = value as string;
