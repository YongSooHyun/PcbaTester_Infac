...
{
    public partial class WaveformGenSettingsForm : Form
    {
        private readonly WaveformGenDeviceSettingsViewModel viewModel = new WaveformGenDeviceSettingsViewModel();

        public WaveformGenSettingsForm()
        {
            InitializeComponent();
        ...
        {
            listView.RefreshObjects(viewModel.GetDeviceSettings());
        }
        ...
        {
            if (viewModel.EditFinished(e.RowObject, e.Column.AspectName, e.NewValue))
            {
