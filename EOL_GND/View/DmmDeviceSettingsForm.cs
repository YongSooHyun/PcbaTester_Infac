...
{
    public partial class DmmDeviceSettingsForm : Form
    {
        private readonly DmmDeviceSettingsViewModel viewModel = new DmmDeviceSettingsViewModel();

        public DmmDeviceSettingsForm()
        {
            InitializeComponent();
