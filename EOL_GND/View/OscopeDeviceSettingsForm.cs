...
{
    public partial class OscopeDeviceSettingsForm : Form
    {
        private readonly OscopeDeviceSettingsViewModel viewModel = new OscopeDeviceSettingsViewModel();

        public OscopeDeviceSettingsForm()
        {
            InitializeComponent();
