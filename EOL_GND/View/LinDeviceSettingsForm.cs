...
{
    public partial class LinDeviceSettingsForm : Form
    {
        private readonly LinDeviceSettingsViewModel viewModel = new LinDeviceSettingsViewModel();

        public LinDeviceSettingsForm()
        {
            InitializeComponent();
