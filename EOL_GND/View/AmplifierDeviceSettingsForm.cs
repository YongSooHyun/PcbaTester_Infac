...
{
    public partial class AmplifierDeviceSettingsForm : Form
    {
        private readonly AmplifierDeviceSettingsViewModel viewModel = new AmplifierDeviceSettingsViewModel();

        public AmplifierDeviceSettingsForm()
        {
            InitializeComponent();
