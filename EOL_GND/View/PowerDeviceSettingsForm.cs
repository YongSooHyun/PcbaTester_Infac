...
{
    public partial class PowerDeviceSettingsForm : Form
    {
        private readonly PowerDeviceSettingsViewModel viewModel = new PowerDeviceSettingsViewModel();

        public PowerDeviceSettingsForm()
        {
            InitializeComponent();
