...
{
    public partial class DioDeviceSettingsForm : Form
    {
        private readonly DioDeviceSettingsViewModel viewModel = new DioDeviceSettingsViewModel();

        public DioDeviceSettingsForm()
        {
            InitializeComponent();

            listView.CellEditUseWholeCell = true;
            commandsColumn.AspectToStringConverter = DioDeviceSettingsViewModel.CommandsToStringConverter;
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            crColumn.IsEditable = editAllowed;
            lfColumn.IsEditable = editAllowed;
        }
        ...
        private void listView_CellEditStarting(object sender, CellEditEventArgs e)
        {
            ...
            // custom edit.
            if (DioDeviceSettingsViewModel.EditProperty(e.RowObject, e.Column.AspectName, e.Value))
            {
                e.Cancel = true;
                listView.RefreshObject(e.RowObject);
            }
        }
