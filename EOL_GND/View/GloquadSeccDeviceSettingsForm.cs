...
{
    public partial class GloquadSeccDeviceSettingsForm : Form
    {
        private readonly GloquadSeccDeviceSettingsViewModel viewModel = new GloquadSeccDeviceSettingsViewModel();

        public GloquadSeccDeviceSettingsForm()
        {
            InitializeComponent();
