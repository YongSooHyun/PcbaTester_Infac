...
namespace InfoBox
{
    ...
    internal partial class InformationBoxForm : Form
    {
                                    ...
                                    InformationBoxSound sound = InformationBoxSound.Default)
        {
            ...
            this.messageText.Font = new Font("Segoe UI", 9);
        ...
        private void SetLayout()
        {
            ...
            int captionWidth = Convert.ToInt32(this.measureGraphics.MeasureString(Text, lblTitle.Font).Width) + 30;
        ...
        private void SetButtonsSize()
        {
            ...
            foreach (Control ctrl in this.pnlButtons.Controls)
            {
                maxSize = Math.Max(Convert.ToInt32(this.measureGraphics.MeasureString(ctrl.Text, ctrl.Font).Width + 50), maxSize);
            }
